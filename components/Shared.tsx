...
// 2. Error State
export const ErrorBanner: React.FC<{ message: string | null }> = ({
  message,
}) => {
...
export const PageHeader: React.FC<PageHeaderProps> = ({
  ...
  <div className="p-5 border-b border-slate-200 bg-slate-50/50 flex flex-wrap items-center justify-between gap-4">
    <div className="flex items-center gap-3">
      <div
        className={`w-10 h-10 rounded-xl flex items-center justify-center text-white shadow-lg ${iconColorClass}`}
      >
        <Icon size={20} />
      </div>
      <div>
...
// 7. Filter Container
export const FilterContainer: React.FC<{ children: React.ReactNode }> = ({
  children,
}) => (
